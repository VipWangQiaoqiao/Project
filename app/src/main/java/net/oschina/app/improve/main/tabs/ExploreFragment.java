    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.layout_events:
                ...
                banner.setCatalog(3);
                banner.setHref("http://192.168.1.10/action/apiv2//banner?catalog=3");
                tab.setBanner(banner);

                tab.setName("线下活动");
                tab.setFixed(false);
                tab.setHref("http://192.168.1.10/action/apiv2/sub_list?token=727d77c15b2ca641fff392b779658512");
