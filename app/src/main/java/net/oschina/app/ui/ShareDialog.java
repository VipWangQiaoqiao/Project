...
public class ShareDialog extends CommonDialog implements
    ...
    private void shareToWeiChatCircle() {
        // 支持微信朋友圈
        //UMWXHandler wxCircleHandler = new UMWXHandler(this.context, Constants.WEICHAT_APPID);
    ...
    private void shareToWeiChat() {
        // 添加微信平台
        //UMWXHandler wxHandler = new UMWXHandler(this.context,Constants.WEICHAT_APPID);
