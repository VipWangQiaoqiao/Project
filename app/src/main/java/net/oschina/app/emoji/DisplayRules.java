...
public enum DisplayRules {
    ...
    Nature0(2, 1, R.drawable.sunny, ":sunny:"),

    Nature1(2, 1, R.drawable.umbrella, ":umbrella:"),

    Nature2(2, 1, R.drawable.cloud, ":cloud:"),

    Nature3(2, 1, R.drawable.snowflake, ":snowflake:"),

    Nature4(2, 1, R.drawable.snowman, ":snowman:"),

    Nature5(2, 1, R.drawable.zap, ":zap:"),

    Nature6(2, 1, R.drawable.cyclone, ":cyclone:"),

    Nature7(2, 1, R.drawable.foggy, ":foggy:"),

    Nature8(2, 1, R.drawable.ocean, ":ocean:"),

    Nature9(2, 1, R.drawable.cat, ":cat:"),

    Nature10(2, 1, R.drawable.dog, ":dog:"),

    Nature11(2, 1, R.drawable.mouse, ":mouse:"),

    Nature12(2, 1, R.drawable.hamster, ":hamster:"),

    Nature13(2, 1, R.drawable.rabbit, ":rabbit:"),

    Nature14(2, 1, R.drawable.wolf, ":wolf:"),

    Nature15(2, 1, R.drawable.frog, ":frog:"),

    Nature16(2, 1, R.drawable.tiger, ":tiger:"),

    Nature17(2, 1, R.drawable.koala, ":koala:"),

    Nature18(2, 1, R.drawable.bear, ":bear:"),

    Nature19(2, 1, R.drawable.pig, ":pig:"),

    Nature20(2, 1, R.drawable.pig_nose, ":pig_nose:"),

    Nature21(2, 1, R.drawable.cow, ":cow:"),

    Nature22(2, 1, R.drawable.boar, ":boar:"),

    Nature23(2, 1, R.drawable.monkey_face, ":monkey_face:"),

    Nature24(2, 1, R.drawable.monkey, ":monkey:"),

    Nature25(2, 1, R.drawable.horse, ":horse:"),

    Nature26(2, 1, R.drawable.racehorse, ":racehorse:"),

    Nature27(2, 1, R.drawable.camel, ":camel:"),

    Nature28(2, 1, R.drawable.sheep, ":sheep:"),

    Nature29(2, 1, R.drawable.elephant, ":elephant:"),

    Nature30(2, 1, R.drawable.panda_face, ":panda_face:"),

    Nature31(2, 1, R.drawable.snake, ":snake:"),

    Nature32(2, 1, R.drawable.bird, ":bird:"),

    Nature33(2, 1, R.drawable.baby_chick, ":baby_chick:"),

    Nature34(2, 1, R.drawable.hatched_chick, ":hatched_chick:"),

    Nature35(2, 1, R.drawable.hatching_chick, ":hatching_chick:"),

    Nature36(2, 1, R.drawable.chicken, ":chicken:"),

    Nature37(2, 1, R.drawable.penguin, ":penguin:"),

    Nature38(2, 1, R.drawable.turtle, ":turtle:"),

    Nature39(2, 1, R.drawable.bug, ":bug:"),

    Nature40(2, 1, R.drawable.honeybee, ":honeybee:"),

    Nature41(2, 1, R.drawable.ant, ":ant:"),

    Nature42(2, 1, R.drawable.beetle, ":beetle:"),

    Nature43(2, 1, R.drawable.snail, ":snail:"),

    Nature44(2, 1, R.drawable.octopus, ":octopus:"),

    Nature45(2, 1, R.drawable.tropical_fish, ":tropical_fish:"),

    Nature46(2, 1, R.drawable.fish, ":fish:"),

    Nature47(2, 1, R.drawable.whale, ":whale:"),

    Nature48(2, 1, R.drawable.whale2, ":whale2:"),

    Nature49(2, 1, R.drawable.dolphin, ":dolphin:"),

    Nature50(2, 1, R.drawable.cow2, ":cow2:"),

    Nature51(2, 1, R.drawable.ram, ":ram:"),

    Nature52(2, 1, R.drawable.rat, ":rat:"),

    Nature53(2, 1, R.drawable.water_buffalo, ":water_buffalo:"),

    Nature54(2, 1, R.drawable.tiger2, ":tiger2:"),

    Nature55(2, 1, R.drawable.rabbit2, ":rabbit2:"),

    Nature56(2, 1, R.drawable.dragon, ":dragon:"),

    Nature57(2, 1, R.drawable.goat, ":goat:"),

    Nature58(2, 1, R.drawable.rooster, ":rooster:"),

    Nature59(2, 1, R.drawable.dog2, ":dog2:"),

    Nature60(2, 1, R.drawable.pig2, ":pig2:"),

    Nature61(2, 1, R.drawable.mouse2, ":mouse2:"),

    Nature62(2, 1, R.drawable.ox, ":ox:"),

    Nature63(2, 1, R.drawable.dragon_face, ":dragon_face:"),

    Nature64(2, 1, R.drawable.blowfish, ":blowfish:"),

    Nature65(2, 1, R.drawable.crocodile, ":crocodile:"),

    Nature66(2, 1, R.drawable.dromedary_camel, ":dromedary_camel:"),

    Nature67(2, 1, R.drawable.leopard, ":leopard:"),

    Nature68(2, 1, R.drawable.cat2, ":cat2:"),

    Nature69(2, 1, R.drawable.poodle, ":poodle:"),

    Nature70(2, 1, R.drawable.paw_prints, ":paw_prints:"),

    Nature71(2, 1, R.drawable.bouquet, ":bouquet:"),

    Nature72(2, 1, R.drawable.cherry_blossom, ":cherry_blossom:"),

    Nature73(2, 1, R.drawable.tulip, ":tulip:"),

    Nature74(2, 1, R.drawable.four_leaf_clover, ":four_leaf_clover:"),

    Nature75(2, 1, R.drawable.rose, ":rose:"),

    Nature76(2, 1, R.drawable.sunflower, ":sunflower:"),

    Nature77(2, 1, R.drawable.hibiscus, ":hibiscus:"),

    Nature78(2, 1, R.drawable.maple_leaf, ":maple_leaf:"),

    Nature79(2, 1, R.drawable.leaves, ":leaves:"),

    Nature80(2, 1, R.drawable.fallen_leaf, ":fallen_leaf:"),

    Nature81(2, 1, R.drawable.herb, ":herb:"),

    Nature82(2, 1, R.drawable.mushroom, ":mushroom:"),

    Nature83(2, 1, R.drawable.cactus, ":cactus:"),

    Nature84(2, 1, R.drawable.palm_tree, ":palm_tree:"),

    Nature85(2, 1, R.drawable.evergreen_tree, ":evergreen_tree:"),

    Nature86(2, 1, R.drawable.deciduous_tree, ":deciduous_tree:"),

    Nature87(2, 1, R.drawable.chestnut, ":chestnut:"),

    Nature88(2, 1, R.drawable.seedling, ":seedling:"),

    Nature89(2, 1, R.drawable.blossom, ":blossom:"),

    Nature90(2, 1, R.drawable.ear_of_rice, ":ear_of_rice:"),

    Nature91(2, 1, R.drawable.shell, ":shell:"),
    ...
    Nature100(2, 1, R.drawable.full_moon, ":full_moon:"),
    ...
    Nature106(2, 1, R.drawable.moon, ":moon:"),

    Nature107(2, 1, R.drawable.earth_africa, ":earth_africa:"),

    Nature108(2, 1, R.drawable.earth_americas, ":earth_americas:"),

    Nature109(2, 1, R.drawable.earth_asia, ":earth_asia:"),

    Nature110(2, 1, R.drawable.volcano, ":volcano:"),

    Nature111(2, 1, R.drawable.milky_way, ":milky_way:"),

    Nature112(2, 1, R.drawable.partly_sunny, ":partly_sunny:"),

    Nature113(2, 1, R.drawable.octocat, ":octocat:"),

    Nature114(2, 1, R.drawable.squirrel, ":squirrel:");
