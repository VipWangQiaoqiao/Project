...
public enum DisplayRules {
    ...
    GITHUB8(1, 1, R.drawable.kissing_heart, ":kissing_heart:", ":kissing_heart:"),
    GITHUB9(1, 1, R.drawable.kissing_closed_eyes, ":kissing_closed_eyes:", ":kissing_closed_eyes:"),
    ...
    GITHUB15(1, 1, R.drawable.stuck_out_tongue_winking_eye, ":stuck_out_tongue_winking_eye:", ":stuck_out_tongue_winking_eye:"),
    GITHUB16(1, 1, R.drawable.stuck_out_tongue_closed_eyes, ":stuck_out_tongue_closed_eyes:", ":stuck_out_tongue_closed_eyes:"),
    GITHUB17(1, 1, R.drawable.grinning, ":grinning:", ":grinning:"),
    GITHUB18(1, 1, R.drawable.kissing, ":kissing:", ":kissing:"),
    GITHUB19(1, 1, R.drawable.kissing_smiling_eyes, ":kissing_smiling_eyes:", ":kissing_smiling_eyes:"),
    GITHUB20(1, 1, R.drawable.stuck_out_tongue, ":stuck_out_tongue:", ":stuck_out_tongue:"),
    ...
    GITHUB29(1, 1, R.drawable.expressionless, ":expressionless:", ":expressionless:"),
    ...
    GITHUB33(1, 1, R.drawable.disappointed_relieved, ":disappointed_relieved:", ":disappointed_relieved:"),
    ...
    GITHUB64(1, 1, R.drawable.purple_heart, ":purple_heart:", ":purple_hert:"),
    ...
    GITHUB71(1, 1, R.drawable.revolving_hearts, ":revolving_hearts:", ":revolving_hearts:"),
    GITHUB72(1, 1, R.drawable.cupid, ":cupid:", ":cupid:"),
    GITHUB73(1, 1, R.drawable.sparkling_heart, ":sparkling_heart:", ":sparkling_heart:"),
    ...
    GITHUB83(1, 1, R.drawable.grey_exclamation, ":grey_exclamation:", ":grey_exclamation:"),
    GITHUB84(1, 1, R.drawable.grey_question, ":grey_question:", ":grey_question:"),
    ...
    GITHUB123(1, 1, R.drawable.two_men_holding_hands, ":two_men_holding_hands:", ":two_men_holding_hands:"),
    GITHUB124(1, 1, R.drawable.two_women_holding_hands, ":two_women_holding_hands:", ":two_women_holding_hands:"),
    ...
    GITHUB129(1, 1, R.drawable.information_desk_person, ":information_desk_person:", ":information_desk_person:"),
    GITHUB130(1, 1, R.drawable.raising_hand, ":raising_hand:", ":raising_hand:"),
    GITHUB131(1, 1, R.drawable.bride_with_veil, ":bride_with_veil:", ":bride_with_veil:"),
    GITHUB132(1, 1, R.drawable.person_with_pouting_face, ":person_with_pouting_face:", ":person_with_pouting_face:"),
    GITHUB133(1, 1, R.drawable.person_frowning, ":person_frowning:", ":person_frowning:"),
    GITHUB134(1, 1, R.drawable.bow, ":bow:", ":bow:"),
    GITHUB135(1, 1, R.drawable.couplekiss, ":couplekiss:", ":couplekiss:"),
    GITHUB136(1, 1, R.drawable.couple_with_heart, ":couple_with_heart:", ":couple_with_heart:"),
    ...
    GITHUB147(1, 1, R.drawable.person_with_blond_hair, ":person_with_blond_hair:", ":person_with_blond_hair:"),
    GITHUB148(1, 1, R.drawable.man_with_gua_pi_mao, ":man_with_gua_pi_mao:", ":man_with_gua_pi_mao:"),
    GITHUB149(1, 1, R.drawable.man_with_turban, ":man_with_turban:", ":man_with_turban:"),
    GITHUB150(1, 1, R.drawable.construction_worker, ":construction_worker:", ":construction_worker:"),
    ...
    GITHUB156(1, 1, R.drawable.heart_eyes_cat, ":heart_eyes_cat:", ":heart_eyes_cat:"),
    ...
    GITHUB160(1, 1, R.drawable.crying_cat_face, ":crying_cat_face:", ":crying_cat_face:"),
    GITHUB161(1, 1, R.drawable.joy_cat, ":joy_cat:", ":joy_cat:"),
    GITHUB162(1, 1, R.drawable.pouting_cat, ":pouting_cat:", ":pouting_cat:"),
    GITHUB163(1, 1, R.drawable.japanese_ogre, ":japanese_ogre:", ":japanese_ogre:"),
    GITHUB164(1, 1, R.drawable.japanese_goblin, ":japanese_goblin:", ":japanese_goblin:"),
    ...
    GITHUB167(1, 1, R.drawable.speak_no_evil, ":speak_no_evil:", ":speak_no_evil:"),
    ...
    GITHUB179(1, 1, R.drawable.bust_in_silhouette, ":bust_in_silhouette:", ":bust_in_silhouette:"),
    GITHUB180(1, 1, R.drawable.busts_in_silhouette, ":busts_in_silhouette:", ":busts_in_silhouette:"),
    GITHUB181(1, 1, R.drawable.speech_balloon, ":speech_balloon:", ":speech_balloon:"),
    GITHUB182(1, 1, R.drawable.thought_balloon, ":thought_balloon:", ":thought_balloon:"),
    ...
    Nature34(2, 1, R.drawable.hatched_chick, ":hatched_chick:", ":hatched_chick:"),
    Nature35(2, 1, R.drawable.hatching_chick, ":hatching_chick:", ":hatching_chick:"),
    ...
    Nature45(2, 1, R.drawable.tropical_fish, ":tropical_fish:", ":tropical_fish:"),
    ...
    Nature53(2, 1, R.drawable.water_buffalo, ":water_buffalo:", ":water_buffalo:"),
    ...
    Nature66(2, 1, R.drawable.dromedary_camel, ":dromedary_camel:", ":dromedary_camel:"),
    ...
    Nature72(2, 1, R.drawable.cherry_blossom, ":cherry_blossom:", ":cherry_blossom:"),
    Nature73(2, 1, R.drawable.tulip, ":tulip:", ":tulip:"),
    Nature74(2, 1, R.drawable.four_leaf_clover, ":four_leaf_clover:", ":four_leaf_clover:"),
    ...
    Nature85(2, 1, R.drawable.evergreen_tree, ":evergreen_tree:", ":evergreen_tree:"),
    Nature86(2, 1, R.drawable.deciduous_tree, ":deciduous_tree:", ":deciduous_tree:"),
    ...
    Nature92(2, 1, R.drawable.globe_with_meridians, ":globe_with_meridians:", ":globe_with_meridians:"),
    Nature93(2, 1, R.drawable.sun_with_face, ":sun_with_face:", ":sun_with_face:"),
    Nature94(2, 1, R.drawable.full_moon_with_face, ":full_moon_with_face:", ":full_moon_with_face:"),
    Nature95(2, 1, R.drawable.new_moon_with_face, ":new_moon_with_face:", ":new_moon_with_face:"),
    Nature96(2, 1, R.drawable.new_moon, ":new_moon:", ":new_moon:"),
    Nature97(2, 1, R.drawable.waxing_crescent_moon, ":waxing_crescent_moon:", ":waxing_crescent_moon:"),
    Nature98(2, 1, R.drawable.first_quarter_moon, ":first_quarter_moon:", ":first_quarter_moon:"),
    Nature99(2, 1, R.drawable.waxing_gibbous_moon, ":waxing_gibbous_moon:", ":waxing_gibbous_moon:"),
    Nature100(2, 1, R.drawable.full_moon, ":full_moon:", ":full_moon:"),
    Nature101(2, 1, R.drawable.waning_gibbous_moon, ":waning_gibbous_moon:", ":waning_gibbous_moon:"),
    Nature102(2, 1, R.drawable.last_quarter_moon, ":last_quarter_moon:", ":last_quarter_moon:"),
    Nature103(2, 1, R.drawable.waning_crescent_moon, ":waning_crescent_moon:", ":waning_crescent_moon:"),
    Nature104(2, 1, R.drawable.last_quarter_moon_with_face, ":last_quarter_moon_with_face:", ":last_quarter_moon_with_face:"),
    Nature105(2, 1, R.drawable.first_quarter_moon_with_face, ":first_quarter_moon_with_face:", ":first_quarter_moon_with_face:"),
    Nature106(2, 1, R.drawable.moon, ":moon:", ":moon:"),
    Nature107(2, 1, R.drawable.earth_africa, ":earth_africa:", ":earth_africa:"),
    Nature108(2, 1, R.drawable.earth_americas, ":earth_americas:", ":earth_americas:"),
