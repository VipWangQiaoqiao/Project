...
import static net.oschina.app.widget.tooglebutton.rebound.ui.Util.createLayoutParams;
import static net.oschina.app.widget.tooglebutton.rebound.ui.Util.createMatchParams;
import static net.oschina.app.widget.tooglebutton.rebound.ui.Util.createMatchWrapParams;
import static net.oschina.app.widget.tooglebutton.rebound.ui.Util.dpToPx;
...
import net.oschina.app.widget.tooglebutton.rebound.OrigamiValueConverter;
import net.oschina.app.widget.tooglebutton.rebound.Spring;
import net.oschina.app.widget.tooglebutton.rebound.SpringConfig;
import net.oschina.app.widget.tooglebutton.rebound.SpringConfigRegistry;
import net.oschina.app.widget.tooglebutton.rebound.SpringListener;
import net.oschina.app.widget.tooglebutton.rebound.SpringSystem;
