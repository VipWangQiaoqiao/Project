 ...
 * 
 */
public class TeamProjectSelectPopupWindow extends PopupWindow implements OnItemClickListener {
	...
	private TeamProjectPopupWindowCallBack mCallBack;
	...
	private void initView(Context context) {
		...
		final View view = (ViewGroup) inflater.inflate(R.layout.popup_window_team_projects_select, null);
	...
	private void getProjectsList() {
		OSChinaTeamApi.getTeamProjectList(Integer.parseInt(mTeam.getId()), mHandler);
	}
