...
public class MyInformationFragment extends BaseFragment {
    ...
    @InjectView(R.id.go_right)
    ImageView mGoRightImg;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Constants.INTENT_ACTION_LOGOUT)) {
                if (mErrorLayout != null) {
                    ...
                    mErrorLayout
                            .setErrorMessage(getString(R.string.unlogin_tip));
                }
    ...
    public void initView(View view) {
        ...
        try {
            mGoRightImg.setImageBitmap(QrCodeUtils
                    .Create2DCode("https://my.oschina.net/javayou"));
