...
public class EventAdapter extends ListBaseAdapter {
	...
	static class ViewHolder {
		...
		@InjectView(R.id.iv_event_status) ImageView status;
	...
	private void setEventStatus(Event event, ViewHolder vh) {
		...
		case EventList.EVENT_LIST_TYPE_NEW_EVENT:
			if (event.getApplyStatus() == Event.APPLYSTATUS_CHECKING || event.getApplyStatus() == Event.APPLYSTATUS_CHECKED) {
				vh.status.setImageResource(R.drawable.icon_event_status_checked);
